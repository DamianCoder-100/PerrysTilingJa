...
//         this.testimonials = document.querySelectorAll(testimonialSelector);
//         this.currentIndex = 0;
...
//     init() {
//         if (!this.container || this.testimonials.length === 0) {
//             console.error("Testimonial container or testimonials not found");
//             return;
//         }
